...
"""基于隐马尔科夫的中文分词，用B、M、E、S分别表示非单字词的开始、非单字词的中间、非单字词的结束、单字词"""
import numpy as np
import pickle
import os


def HMMBasedCut(text: str, dictionary_path: str = "default_dict.txt", params_dir: str = "cwsParams",
                init: bool = False):
    """ 基于隐马尔科夫的中文分词
...
def cws_HMMBased_init(dictionary_path: str, params_dir: str):
    """ 初始化
