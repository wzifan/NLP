...
def shortestPathCut(text: str, dictionary_path: str = "default_dict.txt", params_dir: str = "cwsParams",
                    big_number: float = 20.0, init: bool = False):
    """ 最短路径法中文分词
        ...
        Args:
            ...
            big_number (float): 相邻字之间如果没有路，则给一个大的值，big_number为该值的大小
            init (bool): 是否要重新初始化
...
def cws_shortestPath_init(dictionary_path: str, params_dir: str):
    """ 初始化
...
def substrPosition(substr: str, s: str):
    """ 求子串在字符串s中的所有位置
